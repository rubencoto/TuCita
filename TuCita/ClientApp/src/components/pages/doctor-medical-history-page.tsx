  ...
  return (
    ...
    >
      <div className="p-8">
        ...
        {/* Informacián importante */}
        <Alert className="mb-6 bg-blue-50 border-blue-200">
          <ClipboardList className="h-4 w-4 text-blue-600" />
          <AlertDescription className="text-blue-800">
            Este es el historial médico completo en modo <strong>solo lectura</strong>. 
            Para agregar nuevos registros, accede desde el detalle de una cita especáfica.
          </AlertDescription>
        </Alert>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Diagnástico</TableHead>
                    ...
                    <TableCell colSpan={5} className="text-center py-12">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-sm text-gray-500">
                          Intenta ajustar los filtros de básqueda
                        </p>
                      </div>
                    </TableCell>
                  </TableRow>
                        ...
                        <TableCell>
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              {record.edadPaciente && (
                                <p className="text-sm text-gray-500">{record.edadPaciente} aáos</p>
                              )}
                            </div>
                          </div>
                        </TableCell>
                                ...
                                <div className="space-y-6 py-4">
                                  ...
                                  <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                      ...
                                      {selectedRecord.edadPaciente && (
                                        <p className="text-sm text-gray-600">{selectedRecord.edadPaciente} aáos</p>
                                      )}
                                    </div>
                                  </div>
                                  ...
                                  <div>
                                    <div className="flex items-center space-x-2 mb-3">
                                      ...
                                      <h3 className="font-semibold text-lg">Diagnásticos</h3>
                                    </div>
                                      ...
                                      <div className="space-y-2">
                                        {selectedRecord.diagnosticos.map((diag) => (
                                          <div key={diag.id} className="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            {diag.codigo && (
                                              <p className="text-sm text-gray-500 mt-1">Cádigo: {diag.codigo}</p>
                                            )}
                                          </div>
                                        ))}
                                      </div>
                                              ...
                                              <div className="space-y-2">
                                                ...
                                                {receta.medicamentos.map((med) => (
                                                  <div key={med.id} className="pl-4 border-l-2 border-blue-300">
                                                    ...
                                                    {med.duracion && <p className="text-sm text-gray-600">Duracián: {med.duracion}</p>}
